...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modalState = {};
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_7__["changeModalState"])(modalState);
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["forms"])(modalState);
  ...
  Object(_modules_drop__WEBPACK_IMPORTED_MODULE_13__["drop"])();
});
...
var accordion = function accordion(triggersSelector, itemsSelector) {
  ...
  var blocks = document.querySelectorAll(itemsSelector); // blocks.forEach((block) => block.classList.add('animated', 'fadeInDown'));
  // btns.forEach((btn) => {
  ...
  btns.forEach(function (btn) {
    return btn.addEventListener('click', function () {
      ...
      if (this.classList.contains('active-style')) {
        btns.forEach(function (btn) {
          return btn.classList.remove('active-style');
        });
        blocks.forEach(function (block) {
          return block.classList.remove('active-content');
        });
...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  var burger = document.querySelector(burgerSelector); //   menu.style.display = 'none';
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var addEventForElem = function addEventForElem(elem) {
...
var changeModalState = function changeModalState(state) {
  var selectSize = document.querySelectorAll('#size');
  var selectMaterial = document.querySelectorAll('#material');
  var selectOptions = document.querySelectorAll('#options');
  var inputPromocode = document.querySelectorAll('.promocode');
...
var drop = function drop() {
  ...
  function unhighlight(item) {
    ...
    if (item.closest('.calc_form')) item.closest('.file_upload').style.backgroundColor = '#fff';else item.closest('.file_upload').style.backgroundColor = '#ededed';
    if (item.closest('.file_upload.pink')) item.closest('.file_upload.pink').style.backgroundColor = '#f7e7e6';
  }
...
var forms = function forms(state) {
  var form = document.querySelectorAll('form'); // const inputs = document.querySelectorAll('input');
  ...
  var clearInputs = function clearInputs(selector) {
...
var showMoreStyles = function showMoreStyles(trigger, wrapperSelector) {
  ...
  var wrapper = document.querySelector(wrapperSelector); // cards.forEach((card) => card.classList.add('animated', 'fadeInUp'));
